...
public final class JsonResp extends LinkedHashMap<String, Object> implements Serializable {
    ...
    public static JsonResp ok() {
        return new JsonResp(true,DEFAULT_REQUEST_SUCCESS_CODE, "ok", null);
    }
    public static JsonResp ok(String msg) {
        return new JsonResp(true,DEFAULT_REQUEST_SUCCESS_CODE, msg, null);
    }

    public static JsonResp data(Object data) {
        return new JsonResp(true,DEFAULT_REQUEST_SUCCESS_CODE, "ok",data);
    }

    // 构建失败
    public static JsonResp error() {
        return new JsonResp(false,DEFAULT_REQUEST_ERROR_CODE, "error", null);
    }

    public static JsonResp error(String msg) {
        return new JsonResp(false,DEFAULT_REQUEST_ERROR_CODE, msg, null);
    }
